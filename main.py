from PyQt6.QtWidgets import QApplication, QLabel, QWidget, QLayout, QLineEdit, QPushButton, QMainWindow, QTableWidget, \
    QTableWidgetItem, QDialog, QVBoxLayout, QComboBox, QToolBar, QStatusBar, QGridLayout, QMessageBox
...
class DataBaseConnection:
    def __init__(self, host='localhost', username="root",
                 password='1yU1VaP8_12!', database='school'):
        self.host = host
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created for fun and up my skills!
...
class EditDialog(QDialog):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Edit Students Data')
        self.setFixedWidth(300)
        self.setFixedHeight(300)
